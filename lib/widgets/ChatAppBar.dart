...
import 'package:all_textzz/config/Assets.dart';
import 'package:all_textzz/config/Palette.dart';
                                    ...
                                    Expanded(
                                        ...
                                        child: Container(
                                            child: Column(
                                              ...
                                              mainAxisSize: MainAxisSize.min,
                                              children: <Widget>[
                                                Text('Abhishek Khanna', style: textHeading),
                                                Text('@Khannaabhi', style: textStyle)
                                            ],
                                        )
                                        )
                                    ),
